...
const ProfileCardComponent = ({
  ...
  iconUrl = "https://reactbits.dev/assets/demo/iconpattern.pngi",
  ...
  const tiltEngine = useMemo(() => {
    ...
    const setVarsFromXY = (x, y) => {
      ...
      // --- SENSITIVITY FIX ---
      // Changed divisors from 5/4 to 12.
      // Higher number = Less tilt (More subtle)
      const properties = {
        "--pointer-x": `${percentX}%`,
        "--pointer-y": `${percentY}%`,
        ...
        "--rotate-x": `${round(-(centerX / 12))}deg`, // Was 5, now 12 (Subtle)
        "--rotate-y": `${round(centerY / 12)}deg`, // Was 4, now 12 (Subtle)
      };
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="pc-card-shell">
        <section className={`pc-card ${isSmoothing ? "smooth-entry" : ""}`}>
